...
See `packages/omd/AGENTS.md` for detailed omd architecture.
...
See `packages/omd/AGENTS.md` for the full guide. Key points:
...
1. **`.Codex/skills/<skill-name>/`** -- active location that Codex loads
